...
public class FragmentOrderSelesai extends Fragment {
    ...
    public FragmentOrderSelesai() {}

    public static FragmentOrderSelesai newInstance() {
        FragmentOrderSelesai fragment = new FragmentOrderSelesai();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
        viewFragment = inflater.inflate(R.layout.fragment_order_selesai, container, false);

        Toast.makeText(viewFragment.getContext(), "Doing in order selesai", Toast.LENGTH_SHORT).show();
    ...
    private String statusChecker(int status){
        if (status == 0){
            return "Order Belum di Bayar";
        }else if (status == 1){
            return "Order Sedang di Konfirmasi";
        }else {
            return "";
        }
    }
