...
public class AdapterRoundedImageViewPager extends PagerAdapter {

    Context mContext;
    LayoutInflater mLayoutInflater;
    private ArrayList<ItemImageViewPager> mResources;

    public AdapterRoundedImageViewPager(Context context, ArrayList<ItemImageViewPager> mResources) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        View itemView = mLayoutInflater.inflate(R.layout.item_rounded_image_pager, container, false);
